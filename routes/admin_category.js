...
router2.get('/',auth,function(req,res) {
 ...
 res.render('/Users/asadbilal/Desktop/shoppingcart/views/layout/category-table.ejs',
...
if(result) {
  ...
  res.render('/Users/asadbilal/Desktop/shoppingcart/views/layout/editcategory.ejs', {
